...
import { useCreateAmc, useUpdateAmcById } from 'services/amcServices';
...
export default function ProductAMCViewForm({ isEdit = false, productAMCAdata }) {
    ...
    const { updateAmc, isLoading: amcServiceIsLoading } = useUpdateAmcById();
    ...
    useEffect(() => {
        if (isEdit && productAMCAdata) {
            reset(defaultValues);
            // setValue('customer_id', productAMCAdata?.customers[0]?._id)
                        ...
                        <Card sx={{ p: 3 }}>
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} md={12}>
                                    <RHFSelect name="amc_type" disabled label="AMC Type">
                                ...
                                <Grid item xs={12} md={12}>
                                    <Autocomplete
                                        ...
                                        renderInput={(params) => (
                                            <TextField {...params} label="Select Product" placeholder="" />
                                        )}
                                ...
                                <Grid item xs={12} md={6}>
                                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                                        <DesktopDatePicker
                                            label="AMC Expiry date" disabled
                                ...
                                <Grid item xs={12} md={6}>
                                    ...
                                    <Autocomplete
                                        ...
                                        renderInput={(params) => (
                                            <TextField {...params} label="Service Category" placeholder="" />
                                        )}
                                    />
                                </Grid>
                                <Grid item xs={12} md={6}>
                                    <RHFTextField
                                        name="ip_address" disabled
                                        label="Ip Address"
                                        fullWidth
                                ...
                                <Grid item xs={12} md={6}>
                                    ...
                                    <Stack spacing={3}>
                                        ...
                                        {invoiceFile !== "" ?
                                            <small style={{ textAlign: 'start' }}><a href={invoiceFile} rel="noreferrer" target="_blank">View File</a></small>
                                            : null}
