...
export default function NotificationTableRow({ row, index, onEditRow, onDeleteRow }) {
  const [openPopover, setOpenPopover] = useState(null);
  // const { image, title, backlink } = row;
  const { _id, title, notificationId, createdAt, adminusers } = row;
  ...
  return (
    <>
      <TableRow hover>
        ...
        <TableCell align="left">{adminusers[0]?.name}</TableCell>
