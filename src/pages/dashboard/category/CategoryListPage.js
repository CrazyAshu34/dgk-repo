...
import { CategoryTableRow, CategoryTableToolbar } from 'sections/@dashboard/category';
import { useDeleteCategoryById, useGetAllCategories } from 'services/categoryServices';
...
export default function CategoryListPage() {
  ...
  const { data, isLoading: categoryIsLoading, isError: categoryIsError } = useGetAllCategories();
