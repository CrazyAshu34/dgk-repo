...
import { ProductAMCAddForm, ProductAMCViewForm } from 'sections/@dashboard/amc';
...
console.log("productAMCAdata=",productAMCAdata);
  ...
  return (
    <>
      <Helmet>
        <title>Product AMC Management: Edit Product AMC Management</title>
      </Helmet>
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        <ProductAMCAddForm isEdit productAMCAdata={productAMCAdata} />
      </Container>
    </>
  );
}
